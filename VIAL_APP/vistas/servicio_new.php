...
<div class="container-fluid">    
  <section class="row m-5" style="min-height: 1000px">   
    <div class="row">
      ...
      <div class="m-2">
          <h1 class="display-5">NUEVO SERVICIO</h1>
        </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="form-group col-lg-12 col-md-12 col-xs-12 mb-2">
        ...
        <textarea class="form-control"  rows="3" id="descripcion" onkeydown="validarFormularios()"></textarea>
      </div>
    ...
    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 m-4">
      <button type='button' id="guardar" class="btn btn-primary"  onclick="insertarServicio()"> 🖪 Guardar Servicio</button>
