...
<div class="container-fluid">    
  <section class="row m-5" style="min-height: 1000px">   
    <div class="row">
      ...
      <div class="m-2">
          <h1 class="display-5">EDITAR SERVICIO</h1>
        </div>
    ...
    <div class="form-group col-lg-5 col-md-5 col-xs-12 mb-2">
      ...
      <div class="form-group col-lg-12 col-md-12 col-xs-12 mb-2">
        ...
        <textarea class="form-control"  rows="3" id="descripcion" onkeydown="validarFormularioEdit()"></textarea>
      </div>
    ...
    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 m-4">
      <button type='button' id="guardar" class="btn btn-primary"  onclick="editarServicio(<?php echo $_GET['id']?>)"> 🖪 Guardar Servicio</button>
